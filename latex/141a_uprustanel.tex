...
\addbibresource{viited_UprusTanel.bib}% Viidete info fail
...
\autor{Tanel Üprus}
\klass{11. a}
\juhendaja{õp. Reivo Maasik}% Juhendajad eraldada \\ sümboliga
...
\verb!141a_UprusTanel.tex! -- see  on fail, mille järgi \LaTeX\ kompileerib uurimistöö \verb!.pdf! failiks. Siia on kirjutatud kogu uurimistöö (või on siin lisatud osad, mis on eraldi failidena kirjutatud).

\verb!trkut.cls! -- see  on class fail, mille järgi \LaTeX\ vormistab uurimistöö.

\verb!141a_UprusTanel.pdf! -- see on  \LaTeX'i  vormistatud uurimistöö \verb!.pdf! formaadis.

\verb!viited_UprusTanel.bib! -- see on oluline fail, kus on kõik informatsioon kasutatud materjalidele, millele tahad viidata. Selle faili võib ise kirjutada, kuid parem on lasta see automaatselt koostada, milleks on võimelised paljud kasutatud materjalide haldajad.
...
\verb!141a_UprusTanel.aux! -- see on \LaTeX'i genereeritud abifail, kui see kustutatakse, siis \LaTeX genereerib selle uuesti \verb!141a_UprusTanel.tex! kompileerimisel. 

\verb!141a_UprusTanel.bbl! -- see on BibLaTex'i genereeritud lisafail, kui see kustutatakse, siis BibLaTeX genereerib selle vajadusel uuesti. Siin on materjalid, millele on tegelikult töös viidatud. Selle järgi koostatakse kasutatud materjalid.

\verb!141a_UprusTanel.blg! -- BiBLaTeX'i genereeritud lisafail. 

\verb!141a_UprusTanel.lof! -- \LaTeX'i genereeritud lisafail. Selle järgi luuakse jooniste sisukord.

\verb!141a_UprusTanel.log! -- \LaTeX'i genereeritud lisafail. Siin asuvad veateated.

\verb!141a_UprusTanel.lot! -- \LaTeX'i genereeritud lisafail. Selle järgi luuakse tabelite sisukord.

\verb!141a_UprusTanel.out! -- \LaTeX'i genereeritud lisafail.
...
\tiny
\lstinputlisting[breaklines]{141a_UprusTanel.tex}
\normalsize
